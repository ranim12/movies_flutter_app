...
import 'package:movies_app/views/detail/cast_list/cast_list_view.dart';
import 'package:movies_app/views/detail/review_list/review_list_view.dart';
import 'package:movies_app/views/detail/similar_movie_list/similar_movies_list_view.dart';
import 'package:movies_app/views/detail/video_list/movie_video_list_view.dart';
...
class _DetailPageState extends State<DetailPage> {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            title: widget.movies.title != null
                ? Text("${widget.movies.title}", style: AppStyle.instance.h5Bold)
                : Text(AppString.instance.textAppName, style: AppStyle.instance.h5Bold)),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _moviesOverviewRow(),
                    CastListView(movie: widget.movies),
                    _tabBar(height),
                  ],
                ),
              )
  ...
  Stack _moviePoster(double height) {
    return Stack(alignment: Alignment.bottomLeft, children: [
      ...
      Padding(
        ...
        child: RedButton(width: 500, height: 750),
      ),
    ]);
  }
        ...
        children: [
          ...
          Container(
              ...
              child: TabBarView(children: [
                MovieTrailerListView(movie: widget.movies),
                SimilarMovieListView(movie: widget.movies),
                ReviewListView(movie: widget.movies)
              ])),
        ],
      ),
    );
  ...
  Text _moviesOverviewRow() {
    return Text(widget.movies.overview.toString(),
        style: AppStyle.instance.bodyXLarge.copyWith(color: AppColors.whiteColor));
  }
  ...
  Row _moviesDetailRow(double width) {
    return Row(
      ...
      children: [
        ...
        Text(widget.movies.voteAverage!.roundToDouble().toString(),
            style: AppStyle.instance.bodyMedium.copyWith(color: AppColors.redColor)),
        SizedBox(
          width: width * .01,
        ),
        Icon(
        ...
        Expanded(
          child: Text(
            ...
            style: AppStyle.instance.bodyMedium.copyWith(color: AppColors.whiteColor),
          ),
        ),
        SizedBox(
          width: width * .04,
        ),
        RedBorderWidget(text: widget.movies.originalLanguage.toString()),
        SizedBox(
          width: width * .01,
        ),
        RedBorderWidget(
          text: widget.movies.adult == true ? "+18" : "+7",
        )
      ],
    );
  }
