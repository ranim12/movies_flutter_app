...
import 'package:movies_app/res/components/text_button_red.dart';
...
class _LoginScreenState extends State<LoginScreen> {
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: _buildLoginBody(height, width, context),
          ),
        ),
      ),
    );
  ...
  Column _buildLoginBody(double height, double width, BuildContext context) {
    return Column(
  ...
  Column _buildLoginBottom(double height, BuildContext context) {
    return Column(
      children: [
        ...
        RowTextWidget(
          ...
          text: AppString.instance.textRegisterTitle,
          clickText: AppString.instance.textSignIn,
        )
      ],
    );
  }
  ...
  Column _buildLoginTop(double height) {
    return Column(
      children: [
        ...
        //title
        TitleWidget(
          titleText: AppString.instance.textLoginTitle,
        ),
        SizedBox(
          height: height * .02,
        ),
  ...
  Column _buildLoginForm(double height, double width) {
    return Column(
      children: [
        _buildEmail(),
        SizedBox(
        ...
        ElevatedButton(
            ...
            child: SizedBox(
              ...
              height: height * .07,
              child: Center(
                child: Text(AppString.instance.textSignIn),
              ),
            )),
        SizedBox(
          height: height * .02,
  ...
  InkWell _buildForgotPass() {
    return InkWell(
      onTap: () {},
      child: TextButtonRed(text: AppString.instance.textForgotPass),
    );
  }
