...
import 'package:movies_app/utils/routes/routes.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<PersonDetailViewModel>.value(value: PersonDetailViewModel())
      ],
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          checkboxTheme: CheckboxThemeData(
              ...
              fillColor: WidgetStateProperty.all(AppColors.redColor)),
          //inputDecoration Theme
          inputDecorationTheme: InputDecorationTheme(
              filled: true,
              fillColor: AppColors.whiteColor.withOpacity(0.1),
              focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(20.0), borderSide: const BorderSide(color: AppColors.redColor)),
              ...
              hintStyle: AppStyle.instance.bodyMedium.copyWith(color: AppColors.whiteColor.withOpacity(0.4))),
        ),
